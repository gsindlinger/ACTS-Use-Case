...
public abstract class SUTObjectAbstract extends SUTObject {
    ...
    public IncludeInvalidValues includeInvalidValues = IncludeInvalidValues.EXCLUDE_INVALID_VALUES;
    ...
    public SUTObjectAbstract(int interactionParameter, IncludeValuesForConstraints includeValuesForConstraints) {
