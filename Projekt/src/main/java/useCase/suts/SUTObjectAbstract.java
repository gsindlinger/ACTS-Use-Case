...
public abstract class SUTObjectAbstract {
    ...
    protected Parameter amountEmployer;
    protected Parameter amountEmployee;
    protected Parameter typeOfFunding;
    protected Parameter implementation;
    protected Parameter typeOfReinsurance;

    public SUTObject.IncludeInvalidValues includeInvalidValues = SUTObject.IncludeInvalidValues.EXCLUDE_INVALID_VALUES;




    public SUTObjectAbstract(int interactionParameter) {
